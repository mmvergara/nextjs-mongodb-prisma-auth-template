...
export default async function Home() {
  ...
  return (
    <main className="flex items-center justify-center flex-col gap-4 pt-[10vh] text-white">
      <h1 className="text-5xl text-center bg-[hsl(0,0%,7%)] p-4 px-8 rounded-sm font-semibold">
        NextJS + MongoDB + Prisma + Auth Template
      </h1>
      <section className="flex gap-4 flex-col items-center justify-center bg-zinc-800 p-8 rounded-md">
